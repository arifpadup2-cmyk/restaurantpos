    ...
    <div class="steps">
      ...
      <div class="step">
        ...
        <div class="step-content">
          ...
          <div style="background: var(--bg); padding: 16px; border-radius: 8px; margin-bottom: 16px;">
            <h4 style="margin-bottom: 12px; color: var(--text);">Step 2.2: Go to Your Folder</h4>
            <p style="margin-bottom: 12px; font-size: 13px;"><em>Tell Command Prompt where your setup files are.</em></p>

            <div style="background: #fff9c4; padding: 12px; border-radius: 8px; margin-bottom: 12px; border-left: 4px solid #fbc02d;">
              <p style="margin-bottom: 8px; color: #f57f17;"><strong>Step 1: Find Your Folder</strong></p>
              <p style="color: #f57f17; margin-bottom: 8px;">1. Open File Explorer</p>
              <p style="color: #f57f17; margin-bottom: 8px;">2. Find where you extracted the ZIP file (Downloads, Desktop, Documents, etc.)</p>
              <p style="color: #f57f17;">3. Right-click the folder → <strong>Copy as path</strong></p>
            </div>

            <p style="margin-bottom: 12px; font-weight: 600; color: var(--text);">Step 2: Paste Your Path into Command Prompt</p>

            <p style="margin-bottom: 8px; color: var(--muted); font-size: 13px;">Type: <code style="background: #fff9c4; padding: 2px 6px; border-radius: 4px;">cd </code> then right-click to paste your path</p>

            <p style="margin-bottom: 12px; color: var(--muted); font-size: 12px;"><strong>Example:</strong></p>
            <div class="code-block"><pre style="margin: 0; color: #666;">cd C:\Users\YourName\Downloads\POS-Setup-Outlet-OUTLET001</pre></div>

            <p style="margin-top: 12px; margin-bottom: 8px; color: var(--muted); font-size: 12px;"><strong>Then press Enter</strong></p>

            <p style="background: #e1f5fe; padding: 10px; border-radius: 6px; color: #01579b; font-size: 12px;">
              ✓ If it worked, prompt shows your folder path (like: <code>C:\Users\John\Downloads\POS-Setup-Outlet-OUTLET001&gt;</code>)
            </p>
          </div>
