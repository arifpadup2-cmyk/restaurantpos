...
ALTER TABLE categories ADD COLUMN IF NOT EXISTS outlet_id TEXT REFERENCES outlets(id) ON DELETE SET NULL;
...
CREATE INDEX IF NOT EXISTS idx_categories_outlet        ON categories(outlet_id)       WHERE outlet_id IS NOT NULL;
