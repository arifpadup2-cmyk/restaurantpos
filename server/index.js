...
const deliveryPath = path.join(__dirname, '..', 'delivery')
...
if (fs.existsSync(deliveryPath)) app.use('/delivery-app', express.static(deliveryPath))
...
async function start () {
  ...
  app.use('/delivery',  deliveryRouter(sql))
