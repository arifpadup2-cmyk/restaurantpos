-- Invoice detail fields (mirrors server/migrations/062): waiter, completion time,
-- complimentary/cancelled totals, and per-line payment breakdown (split payments).
